...
//   const postTemplate = path.resolve('./src/templates/Post.jsx');
//   const postsIndexTemplate = path.resolve('./src/templates/PostsIndex.jsx');
//   console.log('//////////////// post teamplate', postTemplate)
...
//     const postsPageInfo = result.data.wpgraphql.posts.pageInfo;
...
//     const allPostsArray = fetchAllItems(postsPageInfo, wpgraphql, 'posts', 'id slug');
//     const postsPerPage = 10;
//     let pageNum = 1;
//     const totalPages = Math.floor((allPostsArray.length / postsPerPage));

//     allPostsArray.forEach((edge) => {
//       createPage({
//         path: `/${edge.node.slug}/`,
//         component: slash(postTemplate),
//         context: {
...
//       createPage({
//         path: `page/${pageNum}`,
//         component: slash(postsIndexTemplate),
//         context: {
//           startCursor: allPostsArray[i].cursor,
//           pageNum,
//           totalPages,
